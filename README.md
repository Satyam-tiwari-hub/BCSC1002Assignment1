...
#### Assignment 1 : Library definitions.Book Inventory System
...
1. a `definitions.Book` class, to define what is a book and its details.
2. a `definitions.Student` class, to define what is a student and its details.
3. a `Library` class, to define a collection of `definitions.Book`s.
4. a `FrontDesk` class, to allow a `definitions.Student` to interact with the `Library`.
...
Allow the `definitions.Student` type to interact with the `FrontDesk` interface and perform simple operations.
...
2. definitions.Student
   ...
   4. a field to store all the names of the books issued by the student (definitions.Book[]).
3. Library
   1. a field to store all the books that are currently available (definitions.Book[]).
4. FrontDesk
   1. a field to store the details of the student currently interacting with the system (definitions.Student).
